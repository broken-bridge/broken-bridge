...
do -- Example UI
	local Window = library:AddWindow("Vaultality Ro-Ghoul", {
		main_color = Color3.fromRGB(0,0,0),
		min_size = Vector2.new(300, 250),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	local CheckTab = Window:AddTab("Check Stats")
        
    do -- Elements
        -- esp --
        bool = game.Players.LocalPlayer.Name
        CheckTab:AddTextBox("Name", function(text)
            bool = text
		end, {
			["clear"] = true, -- Default: true (options are optional)
		})
        local Console = CheckTab:AddConsole({
			["y"] = 130,
			["source"] = "Lua",
		})
		local ns = "\n"
		CheckTab:AddButton("Check", function()
            Console:Set("Level : "..game:GetService("Players")[bool].PlayerFolder.Stats.Level.Value
                ..ns.."Kagune / Quinque : "..game:GetService("Players")[bool].PlayerFolder.Stats.Weapon.Value
                ..ns.."Physical : "..game:GetService("Players")[bool].PlayerFolder.Stats.Physical.Value
                ..ns.."Speed : "..game:GetService("Players")[bool].PlayerFolder.Stats.Speed.Value
                ..ns.."Durability : "..game:GetService("Players")[bool].PlayerFolder.Stats.Durability.Value
                ..ns.."Yen : "..game:GetService("Players")[bool].PlayerFolder.Stats.Yen.Value
                ..ns.."RC : "..game:GetService("Players")[bool].PlayerFolder.Stats.RC.Value
            )
		end)
	end
